...
- **Tests referencing the engine (6):** `tests/adversarial/test_m2_challenges.py`, `tests/unit/test_audit_fixes.py`, `tests/unit/test_clean_core_tokenizer.py`, `tests/unit/test_domain2_engines.py`, `tests/unit/test_property_parsers.py`, `tests/unit/test_rule_catalog.py`

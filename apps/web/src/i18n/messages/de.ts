...
export const de: Messages = {
  ...
  legal: {
    ...
    cookies: {
      ...
      necessary: 'Notwendig',
      items: [
        { name: 'erppreflight_session', purpose: 'Hält Sie angemeldet (von der API gesetzt, HTTP-only, für Skripte nicht lesbar).', duration: '7 Tage' },
        { name: 'erp_csrf', purpose: 'Schützt Ihre Sitzung vor Cross-Site-Request-Forgery (von der API gesetzt, enthält keine Zugangsdaten).', duration: '7 Tage' },
        ...
        { name: 'erppreflight_tenant_id, erppreflight_session_epoch', purpose: 'Browserspeicher für die aktive Organisation und ein An-/Abmeldesignal zwischen Tabs (keine Zugangsdaten).', duration: 'Bis zur Abmeldung' },
      ],

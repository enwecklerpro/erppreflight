...
| **Pricing page data** | `apps/web/src/lib/plans.ts` | Temporary typed mirror of the API tiers (`entitlements.service.ts`); repoint to the shared plan catalog when it exists. A test fails if the mirror drifts from the API tiers. |
